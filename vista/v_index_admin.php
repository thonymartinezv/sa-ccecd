...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="content-index">
              ...
              <tr>
                ...
                <td>
                  ...
                  <button class="btn btn-info" type="button" data-toggle="modal"
                    data-target="#deshabilitarEmpleado<?=$empleado["ci_emp"]?>" <?php
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel"><?=$empleado["p_nomb"]?> <?=$empleado["p_apel"]?>
                      </h5>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control" value="<?=$empleado["email_emp"]?>"
                                  name="email_emp" <?=$_SESSION["pri_otic"]<2?"disabled":""?>>
                                <div class="input-group-append">
                          ...
                          <li class="list-group-item">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="pri_usu" value="2"
                                <?=$empleado["pri_usu"] > 1?"checked":""?> <?php if ($empleado["email_emp"] == $_SESSION['email_otic'] || $_SESSION['pri_otic'] < 2) {
                                  echo "disabled";
                                }?>>
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        <?=$empleado["estado_usu"]>0?"Deshabilitar a":"Habilitar a"?> <?=$empleado["p_nomb"]?>
                        <?=$empleado["p_apel"]?></h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    ...
                    <div class="modal-body">
                      <div class="d-flex justify-content-center my-5 py-5">
                        <p class="h5">¿Seguro que desea <?=$empleado["estado_usu"]>0?"deshabilitar":"habilitar"?> al
                          usuario <strong><?=$empleado["email_emp"]?>@mppct.gob.ve?</strong></p>
                      </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="crearEmpleado" tabindex="-1" role="dialog"
          aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="modal-body">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item">
                      <div class="form-group">
                        <label for="exampleInputEmail1"><strong>Cédula:</strong></label>
                        <input type="text" class="form-control" value="" name="ci_emp">
                      </div>
                    </li>
                    <li class="list-group-item">
                      <div class="form-group">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="button" value="" onClick="crear()"
                  class="btn btn-success">Guardar</button>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    function enviar(pag) {
      if (pag && pag != "0") {
        var url = "?r=admin_index&pag=" + pag + "&num=" + <?= $cantidad ?>
          + "<?=( (isset($search) && $search) ?(" & search=".$search):"")?>"
      } else {
        var url = "?r=admin_index&num="
          + <?= $cantidad ?>
            + "<?=( (isset($search) && $search) ?(" & search=".$search):"")?>"
      }
